...
export default function IpdViewBillPage() {
  ...
  const items = raw.bill_items ?? [];
  const payments = raw.payment_history ?? [];
      ...
      <div className="bill-print-zone">
        <div className="bill-letterhead" role="banner">
          ...
          <div className="bill-letterhead__meta">
            ...
            <p className="bill-letterhead__id">{raw.bill_number}</p>
            <p>Date: {raw.bill_date || '—'}</p>
          </div>
        </div>
        ...
        <div className="bill-meta-row">
          ...
          <div className="bill-meta-col">
            ...
            <p>Admission: {raw.admission_no || service.admission_no || '—'}</p>
