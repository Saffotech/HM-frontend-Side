/**
 * Pharmacist Profile — live GET/PUT /pharmacy/profile + image APIs.
...
import {
  PHARMACIST_PROFILE_EDITABLE_TOP_KEYS,
  resolvePharmacistProfileImageUrl,
} from '@/features/pharmacy/api/profile';
import {
  useDeletePharmacistProfileImageMutation,
  usePharmacistProfileQuery,
...
import './PharmacistProfilePage.css';
...
function buildDirtyPayload(form, baseline) {
  ...
  PHARMACIST_PROFILE_EDITABLE_TOP_KEYS.forEach((key) => {
    if (key === 'languages') {
...
function ReadField({ label, value }) {
  ...
  return (
    <div className="pharmacy-profile-field">
      <span className="pharmacy-profile-field__label">{label}</span>
      <p
        className={`pharmacy-profile-field__value${!display ? ' pharmacy-profile-field__value--empty' : ''}`}
      >
        {display || 'Not set'}
      </p>
    </div>
...
export default function PharmacistProfilePage() {
  ...
  const deleteImage = useDeletePharmacistProfileImageMutation();
  ...
  const [activeTab, setActiveTab] = useState(() => {
    const tab = location.state?.pharmacistProfileTab;
  ...
  const displayName = useMemo(() => {
    if (!profile) return 'Pharmacist';
    const name = `${profile.first_name || ''} ${profile.last_name || ''}`.trim() || profile.email;
    return displayProfileText(name);
  }, [profile]);

  const imageUrl = resolvePharmacistProfileImageUrl(profile?.profile_image_url);
        ...
        <EmptyState
          ...
          description={
            ...
            || (error?.status === 403
              ...
              : error?.status === 404
                ? 'Pharmacist profile not found. Contact admin to create your pharmacist profile.'
  ...
  if (!profile) {
    return (
      <PharmacyLayout pageTitle="My Profile">
        <EmptyState
          icon={User}
          title="Pharmacist profile not found"
          description="Contact admin to create your pharmacist profile."
        />
    ...
    <PharmacyLayout pageTitle="My Profile">
      <div className="pharmacy-profile-page">
        <div className="pharmacy-profile-card">
          <div className="pharmacy-profile-hero">
            <div className="pharmacy-profile-avatar-wrap" ref={avatarWrapRef}>
              <button
                type="button"
              ...
              >
                {imageUrl ? (
                  ...
                  <div className="pharmacy-profile-avatar-fallback" aria-hidden>
            ...
            <div className="pharmacy-profile-hero__meta">
              <div className="pharmacy-profile-hero__top">
                <div>
                  <h2 className="pharmacy-profile-hero__name">{displayName}</h2>
                  <p className="pharmacy-profile-hero__sub">{profile.email}</p>
                </div>
              </div>
              <div className="pharmacy-profile-hero__tags">
                {departmentName ? (
                  <span className="pharmacy-profile-tag">{departmentName}</span>
                ) : null}
                {roleName ? <span className="pharmacy-profile-tag">{roleName}</span> : null}
                <span
                  className={`pharmacy-profile-tag ${
                    profile.is_profile_completed
                      ? 'pharmacy-profile-tag--ok'
                      : 'pharmacy-profile-tag--warn'
                  }`}
                >
                  {profile.is_profile_completed ? 'Profile complete' : 'Incomplete'}
                </span>
                {profile.is_active ? (
                  <span className="pharmacy-profile-tag pharmacy-profile-tag--ok">Active</span>
                ) : (
                  <span className="pharmacy-profile-tag pharmacy-profile-tag--warn">Inactive</span>
                )}
              </div>
              {/* Nurse Phase 2 by Atharva — completion progress + updated ago side by side */}
              <div className="pharmacy-profile-hero__status-row">
                <div
                  className="pharmacy-profile-progress"
                  role="progressbar"
                ...
                >
                  <div className="pharmacy-profile-progress__track">
                    <div
                      className="pharmacy-profile-progress__fill"
                      style={{ width: `${completionPct}%` }}
                    />
                  </div>
                  <span className="pharmacy-profile-progress__label">{completionPct}% complete</span>
                </div>
                {formatUpdatedAgo(profile.updated_at) ? (
                  <p className="pharmacy-profile-hero__updated">
          ...
          <div className="pharmacy-profile-page__toolbar">
            <div className="pharmacy-profile-tabs" role="tablist" aria-label="Profile sections">
              {[
                ...
                return (
                  <button
                    ...
                    className={`pharmacy-profile-tab${activeTab === tab.id ? ' is-active' : ''}`}
            ...
            <div className="pharmacy-profile-page__actions">
              {editing ? (
                <>
          ...
          <form id="pharmacy-profile-form" className="pharmacy-profile-body" onSubmit={handleSave}>
            {activeTab === 'account' && (
              <section
                id="pharmacy-profile-section-account"
                className="pharmacy-profile-section is-active"
                role="tabpanel"
              >
                <h3 className="pharmacy-profile-section__title">
                  <Shield size={16} aria-hidden /> Account
                </h3>
                <p className="pharmacy-profile-hint">
            ...
            {activeTab === 'professional' && (
              <section
                id="pharmacy-profile-section-professional"
                className="pharmacy-profile-section is-active"
                role="tabpanel"
              >
                <h3 className="pharmacy-profile-section__title">
                  ...
                  {editing && form ? (
                    <>
                      <label className="pharmacy-profile-field">
                        <span className="pharmacy-profile-field__label">Qualification</span>
                        <input
                      ...
                      <label className="pharmacy-profile-field">
                        <span className="pharmacy-profile-field__label">Pharmacy license</span>
                        <input
                          className="pharmacy-profile-input"
                      ...
                      <label className="pharmacy-profile-field">
                        <span className="pharmacy-profile-field__label">Experience (years)</span>
                        <input
                          className="pharmacy-profile-input"
                          type="number"
                          min={0}
                      ...
                      <div className="pharmacy-profile-field pharmacy-profile-field--span">
                        <span className="pharmacy-profile-field__label">Languages</span>
                        <div className="pharmacy-profile-lang-row">
                          {parseProfileLanguages(form.languages).map((lang) => (
                            <button
                              key={lang}
                              type="button"
                              className="pharmacy-profile-lang-chip"
                        ...
                        <div className="pharmacy-profile-lang-add">
                          <input
                            className="pharmacy-profile-input"
                      ...
                      <label className="pharmacy-profile-field pharmacy-profile-field--span">
                        <span className="pharmacy-profile-field__label">Bio</span>
                        <textarea
                          className="pharmacy-profile-input"
                          rows={3}
                          value={form.bio}
                    ...
                    <>
                      ...
                      <ReadField label="Pharmacy license" value={profile.license_number} />
                      <ReadField
            ...
            {activeTab === 'contact' && (
              <section
                id="pharmacy-profile-section-contact"
                className="pharmacy-profile-section is-active"
                role="tabpanel"
              >
                <h3 className="pharmacy-profile-section__title">
                ...
                <div className="pharmacy-profile-grid">
                  {editing && form ? (
                    <>
                      ...
                      <label className="pharmacy-profile-field">
                        <span className="pharmacy-profile-field__label">Emergency contact name</span>
                        <input
                          className="pharmacy-profile-input"
                          maxLength={120}
                      ...
                      <label className="pharmacy-profile-field">
                        <span className="pharmacy-profile-field__label">Emergency phone</span>
                        <input
                          className="pharmacy-profile-input"
                          type="tel"
                          inputMode="numeric"
                      ...
                      <label className="pharmacy-profile-field">
                        <span className="pharmacy-profile-field__label">Gender</span>
                        <select
                          className="pharmacy-profile-input"
                          required
                      ...
                      <label className="pharmacy-profile-field">
                        <span className="pharmacy-profile-field__label">State</span>
                        <input
                          className="pharmacy-profile-input"
                          maxLength={100}
                          value={form.state}
                      ...
                      <label className="pharmacy-profile-field pharmacy-profile-field--span">
                        <span className="pharmacy-profile-field__label">Address line</span>
                        <textarea
                          className="pharmacy-profile-input"
                          rows={2}
