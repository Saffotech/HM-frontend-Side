...
export function mapMedicationToPrescription(
  ...
  return {
    ...
    strength: item.dosage ?? item.strength ?? '',
    dosage: item.dosage ?? '',
    form: item.form ?? null,
    route: item.route ?? '',
...
export function mapMedicationHistoryRow(row) {
  ...
  return attachPatientUid({
    ...
    strength: row.dosage ?? row.strength ?? '',
    dosage: row.dosage ?? '',
    form: row.form ?? null,
    route: row.route ?? '',
