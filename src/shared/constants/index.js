...
export const ROUTES = {
  ...
  LAB_NOTIFICATIONS: '/lab/notifications',
  ...
  ADMIN_DEPARTMENTS_NEW: '/admin/departments/new',
  ADMIN_DEPARTMENT_DETAIL: '/admin/departments/:id',
  ADMIN_ROLES: '/admin/roles',
  ADMIN_REPORTS: '/admin/reports',
  ADMIN_REPORTS_VISITS: '/admin/reports/visits',
  ADMIN_BED_ALLOCATION: '/admin/bed-allocation',
  ADMIN_BED_ALLOCATION_NEW: '/admin/bed-allocation/new',
  ADMIN_BED_ALLOCATION_DETAIL: '/admin/bed-allocation/:id',
  ADMIN_BED_ALLOCATION_EDIT: '/admin/bed-allocation/:id/edit',
  ...
  SUPER_ADMIN_STAFF_NEW: '/super-admin/staff/new',
  SUPER_ADMIN_STAFF_DETAIL: '/super-admin/staff/:id',
  SUPER_ADMIN_DEPARTMENTS: '/super-admin/departments',
  SUPER_ADMIN_DEPARTMENTS_NEW: '/super-admin/departments/new',
  SUPER_ADMIN_DEPARTMENT_DETAIL: '/super-admin/departments/:id',
